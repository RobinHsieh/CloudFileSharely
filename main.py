...
# up_color.update_cells_color(0, 23, 0.8, 0.8, 0.8, f_i.spreadsheet_id_dic.get("L11.csv"), f_i.singleSheet_namelist[5])
# up_color.update_cells_color(0, 15, 0.8, 0.8, 0.8, f_i.spreadsheet_id_dic.get("L12.csv"), f_i.singleSheet_namelist[6])
...
print("@.@ *_* >o< @.@ *_* >o< @.@ *_* >o< @.@ *_* >o< @.@ *_* >o<|")
# handle_csv.send_mail(data_L11, f_i.L11_video_id_dic, f_i.spreadsheet_id_dic.get("L11.csv"), f_i.singleSheet_namelist[5])
# print("@.@ *_* >o< @.@ *_* >o< @.@ *_* >o< @.@ *_* >o< @.@ *_* >o<|")
# handle_csv.send_mail(data_L12, f_i.L12_video_id_dic, f_i.spreadsheet_id_dic.get("L12.csv"), f_i.singleSheet_namelist[6])
# print("@.@ *_* >o< @.@ *_* >o< @.@ *_* >o< @.@ *_* >o< @.@ *_* >o<|")
