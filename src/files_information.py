...
spreadsheet_id_dict = {
    ...
    # 舊週三班
    # "L4.csv": "1cz6I5zQtIvttM_xOOOcE4L9DtKYUq2iJRWfPh0qhN1g",
    ...
    # 週三班
    "L0.csv": "1HJGiye3N7Z1pezwyaSq2DukBuG7RAMtiJl7v_xiGM34",  # 0
    "L1.csv": "1pk3kNFAKDDV7ayvOkrTAm8QW6yVjxtKsDLsHo9QzPG0",  # 1
    ...
    "L2.csv": "1LHA3Z0urv4mQos0Ug3aN24BOjXM9cvFiuyuebbf3gA8", # 2
    "L6.csv": "1L_U3zDsGCx_PS6wdi233xwOtDsqtL9IyocIMGgNwf9o"  # 3
    }
...
# 舊週三班
# L4_video_id_dict = {5: "1tNFBwjCRBgzfkow313pBhlT_OYBRgO1N", 6: "1InkySFIMhDJVsATlIy7KxSIg_yfUdHIy",  # '11/30', '12/7'
...
# L5_video_id_dict = {5: "1BjcYW0I9_IzhJ1niFaF5MrW0tuHG4pYn", 6: "1-E0tMgQ9ZyDr54vwVLaYePbnFIUJbEKb",  # '3/1', '3/8'
...
# L6_video_id_dict = {5: "1iSkL7NIy4zXo-lOUiNtWtC-xXHP9oWSQ", 6: "17d-CH8V5yTBLC6MugrLyvilQyVKuRcMM",  # '6/7', '6/14'
...
# L7_video_id_dict = {5: "1vT-S8QS9zLcdIpeQ3CryOHspR5YBh-BE", 6: "1P2GwguH5CSb9oX6AujgFWjmbB3xFyNle",  # '8/30', '9/6'
...
# 週三班
L0_video_id_dict = {5: "1V1Gznfk8orwQuHc--nS3Jokco10vKvGb", 6: "1wzCTSym9k7Oih95AcQ5EJgLOnmu29Lmj",  # '09/25', '10/09'
                   7: "1Lbpfk5PWYxdyUybqGrOhb75-VA0Cqyc7", 8: "1-XXVPx79pDHdmJH4SBs3XVkMdTvjC6k_",  # '10/16', '10/23'
                   9: "1oyHP3EdzutuBrEEhTi1drXqpybBYRgsa", 10: "1Gzs0UXSLgHfbEW3gwLUFdLknDc3NlS9_",  # '10/30', '11/06'
                   11: "1AWXMnsCSx9ieGGB-K7YJqQBEHn7peo69", 12: "1CqiV5wHltbMYfjqFsUTaKMzDUl5ON_7W",  # '11/13', '11/20'
                   13: "1__SKJFeyHVERSlTZdk9uFgg190psR2Kr", 14: "1mWoZUIzkAVk1Mo-Tu9kvflh_X_qDnv2J",  # '11/27', '12/11'
                   15: "1zw28ipmKXKJwKyAhhcLadBcQgMQws5ZR", 16: "17LiMMvDeFuJTIxs1bgpNfHRQDeBmyigQ"}  # '12/18', '12/25'

L1_video_id_dict = {5: "1cTgyMEVKzGOLyMjvaC5QKsG9zp0cDYAj", 6: "1QOH5pzUiiAZTEFlVJTy4UV-C2Dlne0nH",  # '01/08', '01/15'
                   7: "1H844Z-H-GP7eBnyamFlj-SMRMOffew2E", 8: "1A20TaodlZ2DiuH9LJp0eWgYcpP7_90mn",  # '01/22', '02/05'
                   9: "1ohjqcNM6Nt7TYbIZrjVGbRSl-6UGTP54", 10: "19_r5MefFz_P1tmZWl_I8PbgJqU-mIcPe",  # '02/12', '02/19'
                   11: "1UvNALPzk9bPILsWPkXM76hxCKrg1W6gm", 12: "1Kh9xyHNsJFBBXopyyGYrashToRAcdYgS",  # '02/26', '03/05'
                   13: "1yictHPmKb-fSGvfc12dnI77tymRLwyQp", 14: "1RyJHoesbkyFltLc2G091iHapTHZOTHSo",  # '03/12', '03/19'
                   15: "1amIrcndyKrZATlVWBMAr9dRGLn5lp7t9", 16: "1NWq3neI1GwL63LH6Z1gXgExBZ6dzC394"}  # '03/26', '04/02'



# 舊週一班
# L9_video_id_dict = {5: "1-S7fhqW1QE9LFzJN7ldJunrI-B-qPtJd", 6: "12gItLsRQnrzBFpfHIfmsju9oQIFF9V20",  # '7/18', '7/25'
...
# L10_video_id_dict = {5: "1njPeT_3aWbECeGIKdpFP79IEk8_43aOp", 6: "1nWzedkYF9LaR8Tu5gBOu1p8nxlJjJ2CC",  # '10/17', '10/24'
...
# L11_video_id_dict = {5: "1mSFKQxlmL4rZPSIG3mTTNNfsqfljNgoS", 6: "1C6pKOnY-fpcjBponMuXr74jw46U3hNSg",  # '1/30', '2/6'
...
# L12_video_id_dict = {5: "1rtiRbkIIMULlrsFmeHyjv999gvNR_cGD", 6: "1kvOKQIjPNSUbneyQb-Y5bZPJOi6XkGcd",  # '5/15', '5/22'
#                     7: "11cTScrFKOtWPx7pwkFuy3G0-M8ByrGp9", 8: "1eTqr2VoMLQyX33V7w3YFumHFcyvuebxL"}  # '5/29', '6/5'



# 週二班
# L13_video_id_dict = {5: "1G_Q4sADsZrFmgTIR8wUkuFZRwDxXqIfK", 6: "1Pbiid6V-lQapYGAWgloU1qpcLwMtKPbP",  # '11/22', '11/29'
...
# L14_video_id_dict = {5: "1CpDLebghx9cM991dQPLvjNwWkyXG06M4", 6: "1_ZrEOsC--rB_PG3DiMft5ZUjd7mj-7Tf",  # '3/14', '3/21'
...
# L1_video_id_dict = {5: "1eaZzanBkiRrSN4-1AJuKC_SlcY1rKRrJ", 6: "1Hgt4Cd2faD_MG0h3YSYlD8oSWLIAN8EN",  # '6/20', '6/27'
...
L2_video_id_dict = {5: "1OYgwxna6vESe9aHdrnYmwZKaDaTrw7Ui", 6: "1m_jiPW2YzYjJdkYRHbs3Bobn-5ovDucw",  # '9/12', '9/19'
...
L6_video_id_dict = {5: "1nKnysl3xS2k0X6feZ78WljtibmIAV3GP", 6: "11k6iLqZV9rZ8u7gtUBn_2tFSsq3JKbqP",  # '10/01', '10/08'
                   7: "1qJijEYyk8QnezJq5ykzycJS7Xdzzqlu3", 8: "1j2acqOcJAddvFPwnOTu0SFXkNwqORetx",  # '10/15', '10/22'
                   9: "1jpU2MdOr6lRGkRhvRjR0F4phIgBPbpnL", 10: "1muzntLmbvj7KRnzn4G0sON2eMFDRGKXz",  # '10/29', '11/05'
                   11: "1PsJPzCLpXEMFOCw77Ql3I48PZ_6Jg5Fe", 12: "1mLkzxTlxVQtGhcZunHF5sHE0cOd7qS4K",  # '11/12', '11/19'
                   13: "1IboMWrcHzJOdQ7fr2MvN7BqHxnuqXRJo", 14: "1iB1E4t5zuxp_IIZlYCndtoMiT418TuzB",  # '11/26', '12/10'
                   15: "1TqumeCFw_lsEK2f_YosrGKTD20ddAc3y", 16: "1Aht9tyW7weICvcdS1ni0StwedDx-QdNU"}  # '12/17', '12/24'
